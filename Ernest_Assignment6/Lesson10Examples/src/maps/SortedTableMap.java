...
public class SortedTableMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  public boolean containsKey(K key) throws IllegalArgumentException {
      checkKey(key);                     //same validation used in get/put/remove

      int j = findIndex(key);            //where key is or should be
      //key is present only if j is in range and keys are equal
      return (j < table.size() && table.get(j).getKey().equals(key));
  }  
  ...
  public static void main(String[] args) {
	    ...
	    map.put(10, "ten");
	    map.put(20, "twenty");
	    map.put(30, null);   //key 30 maps to null on purpose
	    ...
	    System.out.println("------------------------");
	    System.out.println("Notice: get(30) and get(40) both return null,");
	    System.out.println("but containsKey(30) is true and containsKey(40) is false.");
	}
}
