...
public abstract class AbstractHashMap<K,V> extends AbstractMap<K,V> {
  ...
  public AbstractHashMap(int cap, int p) { this(cap, p, 0.5); }		//default load factor

  /** Creates a hash table with capacity 17 and prime factor 109345121. */
  public AbstractHashMap(int cap) { this(cap, 109345121, 0.5); }	//default prime, load

  
  public AbstractHashMap() { this(17, 109345121, 0.5); }	//default capacity, prime, load
  
  
  
  
  public AbstractHashMap(int cap, double maxLoadFactor) {
	    this(cap, 109345121, maxLoadFactor);
	  }

  public AbstractHashMap(double maxLoadFactor) {
	    this(17, 109345121, maxLoadFactor);
	  }
  ...
  public V put(K key, V value) {
    ...
    if ((double) n /capacity > maxLoadFactor) // resize if current load factor exceeds the configured threshold
