...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public Position<E> inorderNext(Position<E> p) throws IllegalArgumentException {
    ...
    //case 1 - if there is a right subtree, go to its left node
    ...
    //parent is either the inorder successor or null
    return parent;
  }
  
  
  
  public void printInorderNext(Position<E> p) {
	    Position<E> next = inorderNext(p);
	    System.out.println("inorderNext(" + p.getElement() + ") = " +
  ...
  //Exercise 2
  public int printHeightsPostorder(Position<E> p) {
	    int maxChildHeight = -1; // so a leaf ends up with height 0

	    for (Position<E> c : children(p)) {
	      int childHeight = printHeightsPostorder(c);
	    ...
	    System.out.println(p.getElement() + " " + myHeight);
	    return myHeight;
	  }

	  /**
	   * Prints, for every position in this tree, its element followed by
	   * the height of its subtree, using a postorder traversal.
	   */
