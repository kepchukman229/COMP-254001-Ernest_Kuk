...
public class TraversalExamples {
  ...
  public static void main(String[] args)
  {
	  ...
	  Position<Integer> n2 = T.addLeft(r, 2);
	  Position<Integer> n6 = T.addRight(r, 6);
	  Position<Integer> n1 = T.addLeft(n2, 1);
	  Position<Integer> n3 = T.addRight(n2, 3);
	  Position<Integer> n5 = T.addLeft(n6, 5);

	  
	  System.out.println("\n\nExercise 1:");
	  T.printInorderNext(n1);
	  T.printInorderNext(n2); 
	  T.printInorderNext(n3); 
	  T.printInorderNext(r);  
	  T.printInorderNext(n5); 
	  T.printInorderNext(n6); 
	  
	  //This is how this tree looks
		//    	 4
		//      / \
		//     2   6
		//    / \  /
	  ...
	  //Exercise 2
	  System.out.println("\n\nExercise 2:");
	  System.out.println("Element and subtree height for each position (postorder):");
	    lbt.printAllSubtreeHeights();
